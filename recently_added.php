...
require_once __DIR__ . "/config.php"; // DB connection file

// -----------------------------------------------------------
// GET RECENTLY ADDED ROOMS (NEWEST FIRST)
// -----------------------------------------------------------
$rooms = [];

$query = "
    SELECT id, title, description, price, city, area
    FROM rooms
...
<head>
  ...
  <title>Recently Added - Room Finder</title>
...
<div class="container">
  <div class="title-box">
    ...
    <p class="muted">These are the newest rooms added by owners.</p>
  </div>
