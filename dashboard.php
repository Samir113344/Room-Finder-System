...
if (strtolower($_SESSION['user']['role'] ?? '') !== 'owner') {
...
<head>
  ...
  <title>Dashboard (Owner) - Room Finder</title>
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .badge{display:inline-block;padding:4px 8px;border-radius:8px;font-size:12px;background:#E0E7FF;color:#1E3A8A;margin-left:8px}
  ...
  <main>
    <div class="container">
      <div class="welcome">
        ...
        <p>Use the shortcuts below to manage your listings and requests.</p>
      </div>

      <div class="grid">
        <div class="card">
          <h3>Add New Room</h3>
          <p>Create a room listing with photos, price, capacity and amenities.</p>
          <a class="btn" href="add_room.php">Go to Add Room</a>
        </div>

        <div class="card">
          <h3>My Rooms</h3>
          <p>View, edit or deactivate your current room listings.</p>
          <a class="btn" href="my_rooms.php">Open My Rooms</a>
        </div>

        <div class="card">
          <h3>Requests from Students</h3>
          <p>See booking/visit requests and take action.</p>
          <a class="btn" href="requests_owner.php">View Requests</a>
        </div>
